...
<template>
  <EditorProject>
    ...
    <EditorLine :indentation="1">
      <h1 id="project-mining-title">
        # Project: Mining Game - Map Generation
      </h1>
    </EditorLine>
    ...
    <section>
      ...
      <EditorLine :indentation="2">
        ...
        >
          <template #text>
            <div>
              <h2 id="project-mining-first-iteration">
                ## First iteration of cave generation
              </h2>
              <p>
    ...
    <section>
      ...
      <EditorLine :indentation="2">
        ...
        >
          <template #text>
            <div>
              <h2 id="project-mining-added-resources">
                ## Added resources to cave generation
              </h2>
              <p>
    ...
    <section>
      ...
      <EditorLine :indentation="2">
        ...
        >
          <template #text>
            <div>
              <h2 id="project-mining-3d-blocks">
                ## The first adaptation of the map generation with 3D blocks
              </h2>
              <p>
    ...
    <section>
      ...
      <EditorLine :indentation="2">
        ...
        >
          <template #text>
            <div>
              <h2 id="project-mining-better-blocks">
                ## The second iteration of the map generation with 3D blocks
              </h2>
              <p>
    ...
    <section>
      ...
      <EditorLine :indentation="2">
        ...
        >
          <template #text>
            <div>
              <h2 id="project-mining-tracks">
                ## The mine cart tracks are in!
              </h2>
              <p>
